    ...
    <div className="max-w-3xl mx-auto">
      ...
      >
        ...
        <p className="mx-auto mt-2 max-w-md text-sm text-[var(--text-mid)]">
          Daftar lengkap donasi Anda, beserta filter status dan riwayat penjemputan akan tersedia
          di sini setelah backend siap. Untuk sementara, ringkasan tampil di dashboard.
        </p>
        <div className="mt-5 flex justify-center gap-2">
          <Link
            href="/donatur/dashboard"
            className="inline-flex items-center gap-2 rounded-xl border border-[var(--brand-200)] bg-white px-4 py-2.5 text-sm font-semibold text-[var(--brand-700)] hover:bg-[var(--brand-50)]"
          >
            Lihat dashboard
          </Link>
          <Link
