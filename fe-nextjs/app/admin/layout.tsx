  ...
  return (
    ...
    >
      <div className="mx-auto grid min-h-screen max-w-7xl gap-6 px-4 py-6 lg:grid-cols-[260px_1fr] lg:px-6">
        <aside className="rounded-[1.7rem] border border-(--brand-100) bg-[linear-gradient(160deg,var(--brand-900),var(--brand-700))] p-5 text-white shadow-(--shadow-soft)">
          ...
          <nav className="mt-8 space-y-2 text-sm">
            ...
            <span className="block rounded-xl border border-white/20 px-3 py-2 text-white/80">
              Moderasi (segera)
            </span>
            <span className="block rounded-xl border border-white/20 px-3 py-2 text-white/80">
              Laporan (CSV)
